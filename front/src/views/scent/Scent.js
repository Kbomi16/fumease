  ...
  return (
    <Container className={styles["container"]}>
      ...
      <div className={styles.text1}>
        ...
        <p>
          [SOLACE: 한줌의 위안] <br />
          위안에서 오는 다양한 감정을 표현한 향수 컬렉션은 시간이 흐르면서
          일어나는 다채로운 향의 변화를 온전히 느낄 수 있는 향수입니다.
          <br /> 세상에 흩어진 모든 이야기에서 영감을 받은 감각적인 향이
          단조로운 일상에 자유롭고 새로운 리듬을 부여합니다. 규정되지 않은
          아름다움을 향수를 통해 경험해보세요.
        </p>
      </div>
      ...
      <Row className={styles["scents"]}>
        {products
          .filter(
            (product) =>
              selectedBrand === null || product.f_brand === selectedBrand
          )
          .map((product) => (
            <Col
              key={product.id}
